<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="mb-0"><i class="bi bi-calendar-event me-2"></i>Nueva clase grupal</h2>
            <small class="text-muted">
                Registra una nueva plantilla de clase grupal
            </small>
        </div>
    </x-slot>
    ...
    <div class="container-xl py-4">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('group-classes.store') }}">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <x-text-input
                                ...
                                :value="old('name')"
                                placeholder="Ejemplo: Yoga principiantes"
                            />
                            ...
                            >
                                ...
                                @foreach ($trainers as $trainer)
                                    <option
                                        ...
                                        @selected(old('trainer_id') == $trainer->user_id)
                                    >
