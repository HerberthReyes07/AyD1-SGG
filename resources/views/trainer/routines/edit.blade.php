<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                <h2 class="mb-0"><i class="bi bi-pencil me-2"></i>Editar rutina</h2>
                <small class="text-muted">{{ $routine->name }}</small>
            </div>
            <a href="{{ route('assignments.show', $routine->trainer_assignment_id) }}" class="btn btn-sm btn-outline-secondary">
